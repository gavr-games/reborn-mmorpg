class RockState {
  constructor(gameObject) {
    ...
    const transformX = gameObject["Rotation"] == 0 ? gameObject["Properties"]["width"] / 2 : gameObject["Properties"]["height"] / 2
    const transformY = gameObject["Rotation"] == 0 ? gameObject["Properties"]["height"] / 2 : gameObject["Properties"]["width"] / 2
